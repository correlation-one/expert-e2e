...
//   forbidOnly: !!process.env.CI,  //useful to ensure all tests run in CI.
  ...
  workers: process.env.CI ? 1 : undefined, //This sets the number of concurrent worker processes. In CI it's set to 1, while in local environments it uses the default (which is often based on the number of CPU cores).
